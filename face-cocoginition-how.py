...
from deepface.basemodels import ArcFace, OpenFace, Facenet, FbDeepFace
...
print(input_shape)
print("model input shape: ", model.layers[1].input_shape[1:])
...
img1 = functions.preprocess_face("/home/quang/Documents/FACE/deepface/tests/dataset/img1.jpg",input_shape)
print(img1.shape)
img1_representation = model.predict(img1)[0,:]
print(img1_representation.shape)
#img2 = functions.detectFace("dataset/img3.jpg", input_shape)
# img2 = functions.preprocess_face("/home/quang/Documents/FACE/deepface/tests/dataset/img2.jpg", input_shape)
