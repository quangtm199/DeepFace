...
from deepface.basemodels import VGGFace, OpenFace, Facenet, Facenet512, FbDeepFace, DeepID, DlibWrapper, ArcFace, Boosting,InsightFace
...
def build_model(model_name,name=None):
	...
	models = {
		...
		'Race': Race.loadModel,
		'InsightFace':InsightFace.loadModel
	}
...
def verify(img1_path, img2_path = '', model_name = 'VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, prog_bar = True, normalization = 'base'):
	...
	Parameters:
		...
		prog_bar (booleArcFaceshold_to_verify": 0.40
			, "model": "VGG-Face"
	...
	if model == None:
		if model_name == 'Ensemble':
			...
			# print("model_namemodel_namemodel_name")
			models = {}
