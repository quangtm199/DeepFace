...
for detector in detectors:
	img = DeepFace.detectFace("tests123/dataset/img11.jpg", detector_backend = detector)
...
dataset = [
	['tests123/dataset/img1.jpg', 'tests123/dataset/img2.jpg', True],
	['tests123/dataset/img1.jpg', 'tests123/dataset/img6.jpg', True]
]

print("-----------------------------------------")


# img_path = "tests123/dataset/img1.jpg"
...
# res = DeepFace.verify(dataset,model_name=model_name,model=model, detector_backend = 'retinaface')
# print(res)

# print("ssd detector")
# res = DeepFace.verify(dataset,model_name=model_name,model=model, detector_backend = 'ssd')
# print(res)

# print("opencv detector")
# res = DeepFace.verify(dataset,model_name=model_name, detector_backend = 'opencv')
# print(res)
...
# res = DeepFace.verify(dataset,model_name=model_name, detector_backend = 'mtcnn')
# print(res)
...
# df = DeepFace.find(model_name="InsightFace",model=model,img_path = "tests123/dataset/img1.jpg", db_path = "tests123/dataset"
# 	#, model_name = 'Dlib'
# )
# print(df.head())
...
# df = DeepFace.find(img_path = "tests123/dataset/img1.jpg", db_path = "tests123/dataset"
...
# dfs = DeepFace.find(model_name = model_name, img_path = ["tests123/dataset/img1.jpg", "tests123/dataset/img2.jpg"], db_path = "tests123/dataset"
# 	#, model_name = 'Dlib'
# )
# print(dfs[0].head())
# print(dfs[1].head())
...
# resp_obj = DeepFace.verify(dataset,model_name = model_name,)
# print(resp_obj)
...
# dataset = [
# 	'tests123/dataset/img1.jpg',
# 	'tests123/dataset/img2.jpg',
# 	'tests123/dataset/img5.jpg',
# 	'tests123/dataset/img6.jpg'
# ]
...
dataset = [
	['tests123/dataset/img1.jpg', 'tests123/dataset/img2.jpg', True],
	['tests123/dataset/img5.jpg', 'tests123/dataset/img6.jpg', True],
	['tests123/dataset/img6.jpg', 'tests123/dataset/img7.jpg', True],
	['tests123/dataset/img8.jpg', 'tests123/dataset/img9.jpg', True],
	['tests123/dataset/img1.jpg', 'tests123/dataset/img11.jpg', True],
	['tests123/dataset/img2.jpg', 'tests123/dataset/img11.jpg', True],

	['tests123/dataset/img1.jpg', 'tests123/dataset/img3.jpg', False],
	['tests123/dataset/img2.jpg', 'tests123/dataset/img3.jpg', False],
	['tests123/dataset/img6.jpg', 'tests123/dataset/img8.jpg', False],
	['tests123/dataset/img6.jpg', 'tests123/dataset/img9.jpg', False],
]
...
# resp_obj = DeepFace.analyze("tests123/dataset/img1.jpg", models=facial_attribute_models)
# print(resp_obj)
...
if False:
	...
	df = DeepFace.find("tests123/dataset/img1.jpg", db_path = "dataset", model_name = 'Ensemble', model = model, enforce_detection=False)
...
img = cv2.imread("tests123/dataset/img1.jpg")
...
img1 = cv2.imread("tests123/dataset/img1.jpg")
img2 = cv2.imread("tests123/dataset/img2.jpg")
...
df = DeepFace.find(img1, db_path = "tests123/dataset")
